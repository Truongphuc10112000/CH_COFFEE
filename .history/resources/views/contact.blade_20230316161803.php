        ...
        <div class="row">
          <div class="tm-top-header-inner">
            <div class="tm-logo-container">
              <img src="assset/img/logo.png" alt="Logo" class="tm-site-logo">
    ...
    <section class="tm-welcome-section">
      <div class="container tm-position-relative">
        <div class="tm-lights-container">
          <img src="vimg/light.png" alt="Light" class="light light-1">
          <img src="vimg/light.png" alt="Light" class="light light-2">
          <img src="vimg/light.png" alt="Light" class="light light-3">
        </div>
        <div class="row tm-welcome-content">
          <h2 class="white-text tm-handwriting-font tm-welcome-header"><img src="vimg/header-line.png" alt="Line" class="tm-header-line">&nbsp;Contact Us&nbsp;&nbsp;<img src="assset/img/header-line.png" alt="Line" class="tm-header-line"></h2>
        ...
        <img src="assset/img/table-set.png" alt="Table Set" class="tm-table-set img-responsive">
      </div>
    </section>
        ...
        <div class="container">
          <div class="row margin-bottom-60">
            ...
            <div class="col-lg-4 col-md-4 tm-footer-div">
              <h3 class="tm-footer-div-title">Get Socia            l</h3>
