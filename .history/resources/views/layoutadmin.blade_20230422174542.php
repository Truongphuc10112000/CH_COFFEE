  ...
  <body>
    <div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
      ...
      <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        ...
        <li class="nav-group"><a href="/loaispadmin" class="nav-link nav-group-toggle" href="#">
            <svg class="nav-icon">
        ...
        <li class="nav-group"><a href="/donhangadmin" class="nav-link nav-group-toggle" href="#">
            <svg class="nav-icon">
        ...
        <li class="nav-item"><a class="nav-link" href="/chitietdonhangadmin">
            <svg class="nav-icon">
              <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-chart-pie"></use>
            </svg> Chi tiết đơn hàng</a></li>


            <li class="nav-item"><a class="nav-link" href="/chitietkhoadmin">
            <svg class="nav-icon">
              <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-chart-pie"></use>
            </svg> Chi tiết gì đó</a></li>


        <li class="nav-group"><a class="nav-link nav-group-toggle" href="/chitietkhoadmin">
            <svg class="nav-icon">
    ...
    <div class="wrapper d-flex flex-column min-vh-100 bg-light">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb my-0 ms-2">
              <li class="breadcrumb-item">
                <!-- if breadcrumb is single--><span>Trang chủ</span>
              </li>
      ...
      <footer class="footer">
        <div><a href="https://coreui.io">Coffee </a><a href="https://coreui.io">House</a> </div>
        <div class="ms-auto">Bản quyền của&nbsp;<a href="https://coreui.io/docs/">Vũ Văn Trường</a></div>
      </footer>
    </div>
